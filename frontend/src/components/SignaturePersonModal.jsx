...
function SignaturePersonModal({ isOpen, onClose, onSave, formCategory }) {
                        ...
                        formCategory !== 'risk-job-analysis' && (
                            <>
                                <div className='flex sm:flex-nowrap flex-wrap sm:mt-8 mt-4 sm:gap-12 gap-2'>
                                    <label>Name</label>
                                    <input className="input-without-icon"
                                        type="text"
                                ...
                                <div className="text-[red] text-[14px] font-[400] sm:mx-[100px]">{nameError}</div>
                            </>
                        )
                    }
                    <div className='flex justify-center'>
                        <button className='button-text bg-[#0072BB] text-[white] px-[20px] py-[10px] rounded-[5px] sm:mt-11 mt-6' onClick={handlePersonSave}>Submit</button>
                    </div>
...
export default SignaturePersonModal;