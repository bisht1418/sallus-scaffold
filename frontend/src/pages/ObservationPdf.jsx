...
function ObservationPdf() {
  ...
  const getObservationDataById = async () => {
    try {
      ...
      if (responseData?.projectDetail?.Isthereneedforfurtheraction !== "no") {
        setSelectedOption1("yes");
      } else {
        setSelectedOption1("no");
      }
      if (responseData?.projectDetail?.Didyoutakeaction !== "no") {
  ...
  function convertToHttps(url) {
    ...
    return url; // Return the original URL if it already uses HTTPS or is malformed
  }
  ...
  return (
    <div>
      ...
      <PdfGenerator isObservation={true}>
        <div className=" border-b-[#cccccc] border-b mt-10">
              ...
              <>
                <form onSubmit={handleSubmit(onSubmit)}>
                  <div className="custom-container !mt-10">
                    <p className="medium-title mb-3">Observer Details:</p>
                    ...
                    <p className="medium-title mb-3">Observation Details:</p>
                    <div className="flex justify-between items-start gap-[30px] flex-wrap w-full ">
                      <div className="w-full lg:w-[calc(50%-20px)] flex flex-col md:flex-row justify-between gap-[20px]">
                        ...
                        <div className="w-[70%]">
                          <select
                            ...
                            {...register(
                              "projectDetail.Observationisrelatedto",
                              {
                                required: true,
                              }
                            )}
                      ...
                      <div className="w-full lg:w-[calc(50%-20px)] flex flex-col md:flex-row justify-between gap-[20px]">
                        <lable className="project-number w-full md:w-[calc(30%-10px)] text-nowrap">
                          ...
                          <div className="w-[70%] flex gap-10 ">
                            <div className="flex gap-2">
                              <input
                                ...
                                checked={
                                  selectedOption.furtherAction === "yes" ||
                        ...
                        <div className="w-[70%] flex flex-col gap-2">
                          ...
                          {mediaAttachment && (
                            <div className="border max-w-[150px]">
                              <img
                                src={convertToHttps(mediaAttachment)}
                                alt="media"
                              />
                            </div>
                          )}
