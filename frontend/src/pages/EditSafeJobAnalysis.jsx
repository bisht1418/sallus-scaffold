...
const EditSafeJobAnalysis = () => {
  ...
  const defaultItems = [
    ...
    {
      checkListName: "High-Visibility Clothes",
      yes: false,
      na: false,
      no: false,
    },
  ...
  const defaultDesignatedWorkArea = [
    ...
    {
      checkListName: "Is there sufficient lighting?",
      yes: false,
      na: false,
      no: false,
    },
    {
      checkListName: "Does the work team have the right skills for the task?",
      yes: false,
      na: false,
      no: false,
    },
    ...
    {
      checkListName: "Is there other work in the area?",
      yes: false,
      na: false,
      no: false,
    },
  ...
  return (
    <div>
      ...
      <div>
        <TopSection
          keys={projectId}
          title={t("EditSafeJobAnalysis")}
          breadcrumData={[t("home"), t("our-service-title"), t("jobAnalysis")]}
        />
      </div>
      ...
      <div className="md:pb-[50px] pb-6 border-b-[#cccccc] border-b">
        <div className="custom-container flex flex-col md:flex-row gap-[20px] justify-between items-center">
          ...
          <Link
            to={`/safe-job-analysis-pdf/${projectId}/${safeJobAnalysisId}`}
            className="uppercase rounded-lg bg-[#0081c8] text-white font-semibold px-3 py-2"
          >
            View Pdf
          </Link>
        </div>
                ...
                <div className="custom-container">
                  <div className="flex flex-col gap-[30px]">
                    <div className="flex gap-4 items-center md:py-[50px] sm:py-8 py-4">
                      <p className="medium-title text-center  w-full">
                        {t("safeJobAnalysis")}
                      </p>
                      {
                        roleOfUser !== 2 && (
                          ...
                          {[...Array(divCount)].map((_, index) => (
                            ...
                            >
                              <div className="flex flex-col justify-start items-start  gap-3  w-full">
                                <label className="project-number">Risk</label>
                  ...
                  <div
                    className={`transition-all duration-500 ease-in-out overflow-hidden ${extendedList ? "max-h-0 opacity-0" : " opacity-100"
                      }`}
                  >
                  ...
                  <div className="text-center md:mt-[100px] sm:mt-12 mt-6">
                    <button
                      ...
                      disabled={editProject && editSignature ? true : false}
                    >
                      ...
                      <div className=" mt-10">
                        <div className=" ">
                          <div className="flex items-center justify-between gap-5">
                            <div>
                              <label className="font-bold text-sm">Risk</label>
                              <input
                                type="text"
...
export default EditSafeJobAnalysis;
